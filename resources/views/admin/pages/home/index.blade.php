...
@section('wrapper')
    <div class="container-fluid">
        @include('admin.elements.title', ['title' => 'Dashboard']);
        <!-- end page title -->
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-success mini-stat text-white">
                    ...
                    <div class="p-3">
                        <div class="float-right">
                            <a href="#" class="text-white-50"><i
                                    class="mdi mdi-briefcase-check h5"></i></a>
                        </div>
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-4">At vero eos et accusamus et iusto
                                            odio dignissimos ducimus qui blanditiis atque quos dolores
                                            et</p>
            ...
            <div class="col-xl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="morris-donut-example" class="morris-chart" style="height: 300px">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="latest-massage">
                            ...
                            <a href="#" class="latest-message-list">
                                <div class="border-bottom mt-3 position-relative">
                                    <div class="float-left user mr-3">
                                        <img src="{{asset('admins/assets/images/users/avatar-3.jpg')}}" alt=""
                            ...
                            <a href="#" class="latest-message-list">
                                <div class="mt-3 position-relative">
                                    <div class="float-left user mr-3">
                                        <img src="{{asset('admins/assets/images/users/avatar-4.jpg')}}" alt=""
                                            class="rounded-circle mb-3">
                                    </div>
                                    <div class="message-time">
